...
<div class="max-w-screen-xl mx-auto mt-6 mb-4 px-4">
    ...
    <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 mt-3">
        <!-- Each project card -->
                ...
                <div class="min-w-full">
                    <div class="bg-base-300 imgRoud shadow">
                        <a class="flex items-center gap-1 text-2xl mt-1">
                            <img src="{project.image}" alt="{project.name}" class="min-w-full" data-atropos-offset="5">
                        </a>
                    </div>
                    <h3>
                        <a href="{project.demo}" target="_blank" rel="noreferrer" class="flex items-center gap-1 text-2xl mt-1">{project.name} 
